...
class CalcV3Obj : public LSimpleObject
{
    Q_OBJECT
public:
    CalcV3Obj(QObject *parent = NULL);
    virtual ~CalcV3Obj() {}

    void calc(); //произвести расчет выходных параметров
    
    inline QString name() const {return "PoolCalculation_v3";}
