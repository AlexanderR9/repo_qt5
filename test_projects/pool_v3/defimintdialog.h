...
//ВНИМАНИЕ: диапазон можно задать как в величинах привычных цен, а так же в виде значений тиков,
//для этого перед значением тика нужно поставить символ 't', (example t3 or t-5646 для отрицательных тиков)
